    ...
    var body: some View {
        ...
        .onAppear {
            ...
            if post.image == nil && post.imageName == nil {
                print("🔄 DEBUG: Post card appeared without image, attempting to load it for post ID: \(post.id)")
                Task {
...
#Preview {
    ImagePostCard(
        post: Post(
            id: "preview-id",
            content: "This is a sample post with an image for preview",
            likeCount: 15,
            commentCount: 3,
            imageName: "placeholder", // Use an image from your assets
            image: nil,
            timeAgo: "10m ago",
            fitnessInfo: nil,
            aiResponse: nil,
